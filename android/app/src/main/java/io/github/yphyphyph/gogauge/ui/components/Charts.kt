    ...
    AndroidView(
        ...
        update = { chart ->
            ...
            chart.xAxis.apply {
                ...
                labelCount = 8
                granularity = 1f
                valueFormatter = IndexAxisValueFormatter(data.map { it.hour })
            }
            ...
            chart.data = BarData(dsIn, dsOut).apply {
                barWidth = 0.35f
    ...
    AndroidView(
        ...
        update = { chart ->
            ...
            val ds = PieDataSet(entries, "").apply {
                colors = palette.map { it.toArgbInt() }
                sliceSpace = 2f
                valueTextSize = 11f
                valueTextColor = labelColor.toArgbInt()
                valueFormatter = object : ValueFormatter() {
    ...
    AndroidView(
        ...
        update = { chart ->
            ...
            chart.xAxis.apply {
                ...
                textColor = labelColor.toArgbInt()
                labelCount = 8
                valueFormatter = IndexAxisValueFormatter(trend.map { it.date.substring(5) })
            }
            chart.axisLeft.apply {
                textSize = 10f
                textColor = labelColor.toArgbInt()
            ...
            chart.data = LineData(costDs, reqDs, tokDs)
            chart.invalidate()
        },
    )
}
